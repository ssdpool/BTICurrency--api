...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\BTICurrency\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/BTICurrency/';
  if (isLinux) dataDir = process.env.HOME + '~/.BTICurrency/';
}
